...
// N = 256
__global__ void
wgmma_m64n256k16_fmix_SS_test(float *gm_d, __nv_bfloat162 *gm_a, __nv_bfloat162 *gm_b,         
  ...
  using GMMA_t = SM90_64x256x16_F32BF16BF16_SS<cute::GMMA::Major::K, cute::GMMA::Major::K>;    
...
__global__ void
wgmma_m64n256k16_fmix_RS_test(float *gm_d, __nv_bfloat162 *gm_a, __nv_bfloat162 *gm_b,         
                                      float *gm_c, uint8_t sm_layout,               
                                      uint64_t repeat_time) {                        
  constexpr int M = 64;
  constexpr int N = 256;
  constexpr int K = 16;
  extern __shared__ char sm_buff[];                                                  
  using GMMA_t = SM90_64x256x16_F32BF16BF16_RS<cute::GMMA::Major::K, cute::GMMA::Major::K>;    
  GMMA_t::CRegisters reg_d;                                                          
  ...
  for (int i = 0; i < sizeof(reg_a)/sizeof(__nv_bfloat162); i += 1) {                        
    reinterpret_cast<__nv_bfloat162&>(reg_a[i]) = sm_a[i];
  }                                                                                  
...
// N = 128
__global__ void
wgmma_m64n128k16_fmix_SS_test(float *gm_d, __nv_bfloat162 *gm_a, __nv_bfloat162 *gm_b,         
				      float *gm_c, uint8_t sm_layout,               
				      uint64_t repeat_time) {                        
  constexpr int M = 64;
  constexpr int N = 128;
  constexpr int K = 16;
  extern __shared__ char sm_buff[];                                                  
  using GMMA_t = SM90_64x128x16_F32BF16BF16_SS<cute::GMMA::Major::K, cute::GMMA::Major::K>;    
  GMMA_t::CRegisters reg_d;                                                          
...
__global__ void
wgmma_m64n128k16_fmix_RS_test(float *gm_d, __nv_bfloat162 *gm_a, __nv_bfloat162 *gm_b,         
				      float *gm_c, uint8_t sm_layout,               
				      uint64_t repeat_time) {                        
  constexpr int M = 64;
  constexpr int N = 128;
  constexpr int K = 16;
  extern __shared__ char sm_buff[];                                                  
  using GMMA_t = SM90_64x128x16_F32BF16BF16_RS<cute::GMMA::Major::K, cute::GMMA::Major::K>;    
  GMMA_t::CRegisters reg_d;                                                          
  GMMA_t::ARegisters reg_a;
...
// N = 64
__global__ void
wgmma_m64n64k16_fmix_SS_test(float *gm_d, __nv_bfloat162 *gm_a, __nv_bfloat162 *gm_b,         
				      float *gm_c, uint8_t sm_layout,               
				      uint64_t repeat_time) {                        
  constexpr int M = 64;
  constexpr int N = 64;
  constexpr int K = 16;
  extern __shared__ char sm_buff[];                                                  
  using GMMA_t = SM90_64x64x16_F32BF16BF16_SS<cute::GMMA::Major::K, cute::GMMA::Major::K>;    
  GMMA_t::CRegisters reg_d;                                                          
...
__global__ void
wgmma_m64n64k16_fmix_RS_test(float *gm_d, __nv_bfloat162 *gm_a, __nv_bfloat162 *gm_b,         
				      float *gm_c, uint8_t sm_layout,               
				      uint64_t repeat_time) {                        
  constexpr int M = 64;
  constexpr int N = 64;
  constexpr int K = 16;
  extern __shared__ char sm_buff[];                                                  
  using GMMA_t = SM90_64x64x16_F32BF16BF16_RS<cute::GMMA::Major::K, cute::GMMA::Major::K>;    
  GMMA_t::CRegisters reg_d;                                                          
  GMMA_t::ARegisters reg_a;
